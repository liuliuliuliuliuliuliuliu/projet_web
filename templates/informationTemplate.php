...
<div class="loading">
        ...
        <div class="header_mid">
            <div class="header_mid_content">
                <h1>Félicitations pour votre inscription réussie!</h1>
                 <div class="main-agileits">
		<div class="form-w3-agile_1">
            <div class="information_personnel">Vos informations</div>
            <div class="table">
            <table>
                <tr>
                    <th>Username： </th>
                ...
                <tr>
                    <th>Nom:</th>
                    <td><?php echo $this->user->nom() ?></td>
                </tr>
                <tr>
                    <th>Prenom:</th>
                    <td><?php echo $this->user->prenom() ?></td>
                </tr>
                <tr>
                    <th>Email:</th>
                    <td><?php echo $this->user->mail() ?></td>
                </tr>
            </table>
            </div>
		</div>
