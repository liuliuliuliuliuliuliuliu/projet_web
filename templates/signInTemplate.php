                    ...
                    <div class="header_mid">
                        <div class="header_mid_content">
                            ...
                            <div class="main-agileits">
                                ...
                                <h2 class="sub-agileits-w3layouts">Se connecter</h2>
                                ...
                                <div class="dejauncompte">
                                    <a href="#/inscription" @click="gotoinscription" style="text-decoration: none">Nouveau compte?</a>
                                </div>
                                </div>
                                </form>
                                </div>
